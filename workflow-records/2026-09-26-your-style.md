...
- Start: `main`, correct OnHairAgent origin, clean working tree. `git pull --ff-only` succeeded (already up to date) after requesting the filesystem permission needed for `.git/FETCH_HEAD`.
- This is a new campaign, not a repost or cleanup of the 22–24 September campaigns. No old-media deletion is authorized by this restart alone.

## Generation

- HeyGen project: https://app.heygen.com/video-agent/88a1da4f41024d8d8236a95f421cf3c5
- Working title: Your Style, Your Moment; HeyGen project title: ON Hair & Beauty Campaign.
- June Avatar and June Voice both visibly selected before submitting the brief and retained on the project page.
...
ON Hair & Beauty မှာ သင်လိုချင်တဲ့ ပုံစံလေးအကြောင်း လာရောက်တိုင်ပင်နိုင်ပါတယ်။
သင့်အတွက် အချိန်လေးပေးပြီး ပုံစံသစ်လေးကို စိတ်ကူးကြည့်ရအောင်။
အသေးစိတ် သိလိုပါက ကျွန်မတို့ကို ဆက်သွယ်မေးမြန်းနိုင်ပါတယ်။

## Read-only distribution preflight

- Safari source group `715798822492338`: loaded exact canonical group; joined, public, 46,472 members. About page showed no advertising prohibition; current feed included commercial jewellery and property posts. Comment identity showed Jia Li; composer identity must be checked before upload.
- Source campaign-phrase search returned the older 22/24 September Reels, not an exact new-campaign match. Those were not reposted.
- Duplicate-name destination `1138478539957433` was resolved by its loaded canonical About URL and member links: joined/public, 43,425 members; visible rules request useful posts and polite behaviour. No submission made, and it must not be mapped by picker order.
...
ON Hair & Beauty မှာ သင်လိုချင်တဲ့ ဆံပင်ပုံစံလေးအကြောင်း လာရောက်တိုင်ပင်နိုင်ပါတယ်။ သင့်အတွက် အချိန်လေးပေးပြီး ပုံစံသစ်လေးကို စိတ်ကူးကြည့်ရအောင်။

အသေးစိတ် သိလိုပါက ON Hair & Beauty ကို ဆက်သွယ်မေးမြန်းနိုင်ပါတယ်။

Facebook-only hashtags: #ONHairAndBeauty #SingaporeMyanmar

## Facebook destination ledger
...
| `211360618921341` | Five pending; explicit limit | Blocked; not submitted |
